 ...
 */
final class Version20200222075655 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE result DROP INDEX UNIQ_136AC113ED766068, ADD INDEX IDX_136AC113ED766068 (username_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE result DROP INDEX IDX_136AC113ED766068, ADD UNIQUE INDEX UNIQ_136AC113ED766068 (username_id)');
